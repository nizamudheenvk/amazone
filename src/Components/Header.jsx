          ...
          <div className="d-flex flex-column flex-lg-row align-items-center justify-content-between">
            ...
            <div className="d-flex align-items-center mb-2 mb-lg-0">
              ...
              <div className="d-none d-md-block">
                <small style={{ color: "#ccc" }}>Delivering to Surat 394210</small><br />
            ...
            {/* Middle: Search Bar */}
            <div className="d-flex flex-grow-1 mx-lg-3 w-100" style={{ maxWidth: "600px" }}>
              <select
                className="form-select rounded-0"
                style={{ maxWidth: "70px", backgroundColor: "#ddd", fontSize: "13px" }}
              >
                <option>All</option>
              </select>
              <input
